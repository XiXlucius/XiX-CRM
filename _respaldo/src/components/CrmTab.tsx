...
function ClientMap({ clients, onOpen }: { clients: Client[]; onOpen: (c: Client) => void }) {
  ...
  return (
    <Card className="p-5">
      ...
      <div className="relative h-[480px] rounded-xl overflow-hidden bg-ink-900/60 border border-tint/5">
        ...
        <div className="absolute bottom-3 left-3 flex flex-wrap gap-2 bg-ink-900/80 backdrop-blur rounded-xl p-2 border border-tint/5">
