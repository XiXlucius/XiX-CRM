    ...
    <div data-tour="config" className="space-y-5">
                  ...
                  return (
                    <th key={r.id} className="px-3 py-2.5 font-medium text-center">
                      <div className="flex flex-col items-center gap-1">
                        <span className={`grid h-7 w-7 place-items-center rounded-lg bg-gradient-to-br ${r.color} text-metal-100`}>
                          <Icon size={13} />
                        </span>
                        {r.label}
                      </div>
      ...
      <Card className="p-5">
        <div className="flex items-start gap-4">
          <div className={`grid h-12 w-12 shrink-0 place-items-center rounded-xl bg-gradient-to-br ${currentRole.color} text-metal-100`}>
