...
export const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'ruta', label: 'Ruta de cobro', icon: 'Route', description: 'Visitas del día, ordenadas por cercanía' },
